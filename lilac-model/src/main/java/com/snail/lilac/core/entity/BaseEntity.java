...
import com.snail.lilac.core.entity.support.UUIDEntity;
...
public abstract class BaseEntity extends UUIDEntity implements IEntity<String> {
    ...
    /*
     * (non-Javadoc)
     * @see com.snail.lilac.core.entity.IEntity#getLastUpdateTime()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.snail.lilac.core.entity.IEntity#setLastUpdateTime(java.util.Date)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.snail.lilac.core.entity.IEntity#getLastUpdateUser()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.snail.lilac.core.entity.IEntity#setLastUpdateUser(com.snail.lilac.core.security.entity.UserInfo)
     */
    @Override
