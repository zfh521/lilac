	...
	<div class="row-fluid sortable">
				...
				<div id="myTabContent" class="tab-content">
					...
					<div class="tab-pane" id="custom">
						...
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
							...
							massa. Sed sit amet nulla ipsum. Donec felis mauris, vulputate
		...
		<div class="box span4">
			...
			<div class="box-content">
				...
				<p class="clearfix">You can update a chart periodically to get
					a real-time effect by using a timer to insert the new data in the
					plot and redraw it.</p>
				<p>
