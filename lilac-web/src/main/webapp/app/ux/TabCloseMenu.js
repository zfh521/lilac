 ...
 */
Ext.define('Lilac.ux.TabCloseMenu', {
  extend: 'Ext.plugin.Abstract',
  alias: 'plugin.lilac.tabclosemenu',
  mixins: {
  ...
  /**
   * @cfg {Boolean} showCloseOthers Indicates whether to show the 'Close Others'
   *      option.
   */
  showCloseOthers: true,

  /**
   * @cfg {String} closeOthersTabsText The text for closing all tabs except the
   *      current one.
   */
  ...
  onContextMenu: function(event, target) {
    var me = this, menu = me.createMenu(), disableAll = true, disableOthers = true, tab = me.tabBar
            .getChildByElement(target), index = me.tabBar.items.indexOf(tab);
